...
gulp.task('package', (cb) => {
    ...
    targetPkgJson['main'] = `bundles/ngx-alerts.umd.js`;
...
gulp.task('bundle', () => {
    ...
    const rollupGenerateOptions = {
        ...
        moduleId: '',
        moduleName: 'ngxAlerts', //require for 'umd' bundling, must be a valid js identifier, see rollup/rollup/issues/584
        format: 'umd',
        globals,
        dest: 'ngx-alerts.umd.js'
    };
